...
//        car inherits from vehile therfore is also a vehicle
//        car methods and vars in memory but not available as standard
...
//        garage.add( new Vehicle("Mini Morris", 4)); //note: this won't work with abstract classes
    ...
    public void objectRemembersItsType() {
        vehicle = new Car("Audi A8", 2);
//        so long as we recast car that was declared as vehicle back to
//        car type, the methods and vars will become accessible;
