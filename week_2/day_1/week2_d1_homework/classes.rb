...
class Team
  ...
  # Create a method that adds a new player to the players array. - Mutator function, changes data but does not return anything.
...
# ---------------------------------------------------------------
  #revision on self keyword:
  def class_and_id_info()
    # within instance method body, self refers to the object itself
    return "This object is made from class: #{self.class},\n
            The ancestors of this parent class #{self.class} are:\n
            #{self.class.ancestors},\n
            The object ID in memory is: #{self.object_id}."
  end

  # IMPORTANT: self means different things in different contexts:
  # For instance, if we use it outside instance method(object method)
  # definition, it will refer to the class itself.
