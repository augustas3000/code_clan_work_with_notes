...
class TestLibrary < Minitest::Test
  ...
  def test_class_and_id_info()
    expected_parent_class = @library_obj.class
    expected_parent_class_ancestors = expected_parent_class.ancestors
    expected_object_id = @library_obj.object_id
    actual = @library_obj.class_and_id_info

    assert_equal("This object is made from class: #{expected_parent_class},\n
            The ancestors of this parent class #{expected_parent_class} are:\n
            #{expected_parent_class_ancestors},\n
            The object ID in memory is: #{expected_object_id}.", actual)
  end
end
