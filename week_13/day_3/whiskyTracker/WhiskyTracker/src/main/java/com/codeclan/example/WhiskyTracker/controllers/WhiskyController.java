...
//    GET /whiskies
//    GET /whiskies?year=2000
//    GET /whiskies?distilleryName=Glendronach&age=12
//    Alternative route for last one - argubly better design /whiskies?distilleryRegion=Speyside
//    DESIGN BEFORE YOU DO IT


//    findWhiskeysByYearOrByDistilleryNameAndAgeQueryString
    @GetMapping
...
//        default - if query string in not provided, then action standard GET INDEX route.
